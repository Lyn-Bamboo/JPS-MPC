...
void visGridPath(vector<Vector3d> nodes, bool is_use_jps, Vector3d start_pt);
...
#define _use_jps 1
#if _use_jps
    {
        ...
        // Visualize the result
        visGridPath(grid_path, _use_jps, start_pt);
        visVisitedNode(visited_nodes);
...
int main(int argc, char **argv)
{
    ...
    // 定义了结构体 AstarPathFinder 变量_astar_path_finder
    // 该结构体存储、实现了 Astar 路径规划所需的所有信息和功能
